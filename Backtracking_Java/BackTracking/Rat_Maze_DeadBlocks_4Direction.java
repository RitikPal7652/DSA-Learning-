...
public class Rat_Maze_DeadBlocks_4Direction {
    ...
    private static void print(int stRows, int stCols, int endRows, int endCols,String s, int[][] maze, boolean[][] isVisited){
        ...
        //If it is already true means we have traversed on it.
        ...
        */
        ...
        //go Right
        print(stRows, stCols+1 ,endRows, endCols, s+"R", maze, isVisited);

        //go down
        print(stRows+1, stCols, endRows, endCols, s+"D", maze, isVisited);

        //go up
        print(stRows-1, stCols, endRows, endCols, s+"U", maze, isVisited);

        //go left
        print(stRows, stCols-1, endRows, endCols, s+"L", maze, isVisited);
